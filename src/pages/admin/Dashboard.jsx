...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const [books, blogPosts, galleryItems, messages] = await Promise.all([
        ...
        setStats({
          ...
          unreadMessages: messages.data.filter(msg => !msg.isRead).length
        });
  ...
  return (
    <DashboardContainer>
      <DashboardHeader>
        <h1>Dashboard</h1>
        <p>Welcome to your bookshop admin panel</p>
      </DashboardHeader>
      ...
      <QuickLinksSection>
        ...
        <QuickLinksGrid>
          ...
          <QuickLink to="/admin/messages">Check Messages</QuickLink>
        </QuickLinksGrid>
      </QuickLinksSection>

      <RecentUpdatesSection>
        <h2>Recent Updates</h2>
        <p>Welcome to your new bookshop website! Start by adding content to your website.</p>
